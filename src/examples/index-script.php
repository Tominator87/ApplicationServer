...
<html>
    ...
    <body>
        <div>
            <ul>
                <li><a href="index-script.php?action=findAll">Home</a></li>
                <li><a href="index.php?action=findAll">AppServer version</a></li>
            </ul>
        </div>
        <div>
        ...
        <div>
            <table>
                ...
                <?php foreach ($entities as $sampleId => $entity) { ?><tr>
                        ...
                        <td><a href="index-script.php?action=delete&sampleId=<?php echo $entity->getSampleId() ?>">Delete</a></td>
                    </tr><?php } ?> 
            </table>
        </div>
    </body>
